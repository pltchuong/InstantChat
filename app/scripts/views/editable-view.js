/*
	Credits: 
	https://github.com/KasperTidemann/ember-contenteditable-view
*/
...
Ember.ContenteditableView = Em.View.extend({
	...
	setContent: function() {
		...
		// use our own value because we don't want it reformat when blur - Phan
		return this.$().html(this.get('value') ? this.get('value') : '');
	}
});